...
<body class="hold-transition sidebar-mini"
      style="background: linear-gradient(180deg, rgb(9,38,70), rgb(47,166,199))">
<!-- Site wrapper -->
<div class="wrapper">
    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background: none; color: white">
        <!-- Left navbar links -->
        <ul class="navbar-nav">
            <li class="nav-item">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="#" class="nav-link" style="color: white">{{\Carbon\Carbon::now()->format('H:i')}}</a>
            </li>
        </ul>
        ...
        <form class="form-inline ml-3">
            <div class="input-group input-group-sm">
                ...
                <div class="input-group-append" >
                    <button class="btn btn-navbar" style="background: rgba(255,255,255,0.4)" type="submit">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4"
        ...
        <a href="{{url('/')}}" target="_blank" class="brand-link">
            {{--<img src="" alt="Лого" class="brand-image img-circle elevation-3" style="opacity: .8">--}}
            <span class="brand-text font-weight-light" style="padding-left: .8rem">АИС "Расписание"</span>
        </a>
