            ...
            <div class="container-fluid d-flex" style="justify-content: space-between">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex">
                        ...
                        <h1>Сотрудники<span class="text-gray ml-3">(справочник)</span></h1>
                    </div>
                </div>
        ...
        <section class="content d-flex">
            ...
            <div class="card" id="data-table">
                <div class="card-header">
                    <div class="card-title d-flex" style="width: 100%; justify-content: space-between">
                        <div class="mr-5">
                            <button id="add-staff" type="button" class="btn btn-info">Добавить сотрудника
                        ...
                        <div class="card-body table-responsive p-0" style="max-height: 300px;">
                            <table class="table table-bordered table-hover text-nowrap">
                                ...
                                <tr class="tr-w-sort" title="Нажмите для сортировки">
                                    <th class="th-w-sort"
                                        data-url="{{route('staffs.sort')}}" data-status="0" data-type="name">
                                        ФИО<i class="fa fa-angle-down ml-2"></i>
                                        <i class="fa fa-angle-up ml-2 hide"></i></th>
                                    <th class="th-w-sort"
                                        data-url="{{route('staffs.sort')}}" data-status="0" data-type="short_name">
                                        Инициалы<i class="fa fa-angle-down ml-2"></i>
                                        <i class="fa fa-angle-up ml-2 hide"></i></th>
                                    <th class="th-w-sort"
                                        data-url="{{route('staffs.sort')}}" data-status="0" data-type="position">
                                        Должности<i class="fa fa-angle-down ml-2"></i>
                                        <i class="fa fa-angle-up ml-2 hide"></i></th>
                                </tr>
                                </thead>
                                <tbody id="ref-tbody">
                                @foreach($staffs as $staff)
                                    <tr class="showStaff text-wrap" data-value="{{$staff->id}}">
                                        <td>{{ $staff->name }}</td>
                ...
                <div class="card-body">
                    <div>
                        ...
                        <div id="loader" class="m-a0 ta-c hide">
                            <img src="{{asset('public/assets/front/img/anim/loader.gif')}}"></div>
                        <div id="form-edit-staff">
                            {{--staffs.edit--}}
                        </div>
                        <div id="form-create-staff" class="hide">
                            @include('references.staffs.create')
                        </div>
            ...
            <div class="popup-fade" style="display: none">
                <div class="popup">
                    ...
                    <p><b>Справочник "Сотрудники"</b></p>
                    <p>Отображает сотрудников в организации. Поля:</p>
                    <ul>
                        <li><b>ФИО</b> - полные фамилия имя отчество;</li>
                        <li><b>Инициалы</b> - фамилия и инициалы имени отчества (напр. "Иванов И.И.");</li>
                        <li><b>Должности</b> - список должностей, которые имеет сотрудник.</li>
                    </ul>
