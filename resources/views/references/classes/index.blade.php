            ...
            <div class="container-fluid d-flex" style="justify-content: space-between">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex">
                        ...
                        <h1>Классы<span class="text-gray ml-3">(справочник)</span></h1>
                    </div>
                </div>
        ...
        <section class="content d-flex">
            ...
            <div class="card" id="data-table">
                <div class="card-header">
                    <div class="card-title d-flex" style="width: 100%; justify-content: space-between">
                        <div class="mr-5">
                            <button id="add-class" type="button" class="btn btn-info">Добавить класс
                        ...
                        <div class="card-body table-responsive p-0" style="max-height: 300px;">
                            <table class="table table-bordered table-hover text-nowrap">
                                ...
                                <tr class="tr-w-sort" title="Нажмите для сортировки">
                                    <th class="th-w-sort"
                                        data-url="{{route('classes.sort')}}" data-status="0" data-type="title">
                                        Название<i class="fa fa-angle-down ml-2"></i>
                                        <i class="fa fa-angle-up ml-2 hide"></i></th>
                                    <th class="th-w-sort"
                                        data-url="{{route('classes.sort')}}" data-status="0" data-type="head">
                                        Классный руководитель<i class="fa fa-angle-down ml-2"></i>
                                        <i class="fa fa-angle-up ml-2 hide"></i></th>
                                    <th class="th-w-sort"
                                        data-url="{{route('classes.sort')}}" data-status="0" data-type="year">
                                        Учебный год<i class="fa fa-angle-down ml-2"></i>
                                        <i class="fa fa-angle-up ml-2 hide"></i></th>
                                </tr>
                                </thead>
                                <tbody id="ref-tbody">
            ...
            <div class="card" id="action-form" style="margin-left: 0.5rem">
                ...
                <div class="card-body">
                    <div>
                        ...
                        <div id="form-create-class" class="hide">
                            @include('references.classes.create')
                        </div>
            ...
            <div class="popup-fade" style="display: none">
                <div class="popup">
                    ...
                    <p><b>Справочник "Классы"</b></p>
                    <p>Отображает список академических классов по учебным годам. Поля:</p>
                    <ul>
                        <li><b>Название</b> - наименование класса (напр. "5А");</li>
                        <li><b>Классный руководитель</b> - сотрудник, который руководит классом;</li>
                        <li><b>Учебный год</b> - учебный год класса.</li>
                    </ul>
